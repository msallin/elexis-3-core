...
public enum Images {
	...
	IMG_WIZ_DAY, 
	/** Calendar */
	IMG_CALENDAR, IMG_COUNTER_STOP, 
	/** Neutral user */
	IMG_USER_IDLE, IMG_SYSTEM_MONITOR, IMG_BELL_EXCLAMATION, IMG_SORT_DATE,
	IMG_SORT_DATE_DESCENDING, IMG_CARDS, IMG_NOBILLING, IMG_BAGGAGE_CART_BOX;
	...
	public InputStream getImageAsInputStream(ImageSize is) throws IOException {
		...
		URL url = FileLocator.find(Activator.getContext().getBundle(), new Path("icons/" + is.name + "/" + fileName),
				null);
