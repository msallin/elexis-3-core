 ...
 * 
 */
public interface ITextPlugin2 extends IExecutableExtension {
	 ...
	 * {@link ITextPlugin2#print(String, String, boolean)} is called or
	 * {@link ITextPlugin2#createContainer(Composite, ICallback)} is executed (applied as default
	 * printer/tray).
	 * 
